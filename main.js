...
var $author$project$Mario$Right = {$: 'Right'};
var $author$project$Mario$initialState = {dir: $author$project$Mario$Right, trace: _List_Nil, vx: 0, vy: 0, x: 0, y: 0};
var $author$project$Mario$Left = {$: 'Left'};
...
var $author$project$Mario$gravity = 0.2;
var $elm$core$Basics$gt = _Utils_gt;
var $author$project$Mario$jumpCutoff = 0.5;
var $author$project$Mario$jumpPower = 8;
...
var $author$project$Mario$runSpeed = 3;
...
var $author$project$Mario$update = F2(
	function (computer, mario) {
		var vx = function () {
			var keyX = $evancz$elm_playground$Playground$toX(computer.keyboard);
			return (!(!keyX)) ? (keyX * $author$project$Mario$runSpeed) : (mario.vx * $author$project$Mario$coast);
		}();
		var dt = 2;
		var gravityApplied = mario.vy - (dt * $author$project$Mario$gravity);
		var vy = ((!mario.y) && computer.keyboard.up) ? $author$project$Mario$jumpPower : (computer.keyboard.up ? gravityApplied : A2($elm$core$Basics$min, $author$project$Mario$jumpCutoff, gravityApplied));
		var newX = mario.x + (dt * vx);
		var newY = A2($elm$core$Basics$max, 0, mario.y + (dt * vy));
		return _Utils_update(
			mario,
			{
				dir: ($evancz$elm_playground$Playground$toX(computer.keyboard) < 0) ? $author$project$Mario$Left : (($evancz$elm_playground$Playground$toX(computer.keyboard) > 0) ? $author$project$Mario$Right : mario.dir),
				trace: A2(
...
var $author$project$Mario$marioSpriteName = function (mario) {
	var stance = (mario.y > 0) ? 'jump' : ((!(!mario.vx)) ? 'walk' : 'stand');
	...
	function (computer, mario) {
		...
		return _List_fromArray(
			[
				...
				A3($evancz$elm_playground$Playground$rgb, 174, 238, 238),
				w,
				h),
				A2(
				$evancz$elm_playground$Playground$rotate,
				A2($evancz$elm_playground$Playground$spin, 8, computer.time),
				A2(
					$evancz$elm_playground$Playground$circle,
					A3($evancz$elm_playground$Playground$rgb, 34, 48, 150),
					200)),
				A2(
				...
				A3(
					...
					A2(
						...
						A2($author$project$Mario$pathToPolygonVertices, 1.5, mario.trace)))),
				A3(
				$evancz$elm_playground$Playground$move,
				mario.x,
				(b + 76) + mario.y,
				A3(
					...
					70,
					70,
					$author$project$Mario$marioSpriteName(mario)))
			]);
	});
var $author$project$Mario$game = {initialState: $author$project$Mario$initialState, updateState: $author$project$Mario$update, view: $author$project$Mario$view};
...
var $author$project$Main$gameApplication = function (game) {
	return A3($evancz$elm_playground$Playground$game, game.view, game.updateState, game.initialState);
};
var $author$project$Main$main = $author$project$Main$gameApplication($author$project$Mario$game);
